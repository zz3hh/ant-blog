export default {
  ...
  'menu.article.all': '首页',
  'menu.article.ask': '提问',
  'menu.article.share': '分享',
  'menu.article.discuss': '讨论',
  'menu.article.suggest': '建议',
  'menu.article.notice': '公告',
  'menu.article.news': '动态',
  'menu.article.job': '招聘',
  "menu.mall.all": "商城",
  "menu.mall.feedback": "用户反馈",
  "menu.mall.maintain": "网站维护中",
  "menu.company": "关于我们",
  "menu.user": "用户中心",
  ...
  "menu.mall.post": "发布文章",
  "menu.mall.post.add": "添加文章",
  "menu.mall.post.list": "文章列表",
